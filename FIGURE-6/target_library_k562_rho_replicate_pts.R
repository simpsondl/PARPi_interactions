...
kphenos2 <- kphenos %>% 
  ...
  select(GuideCombinationID, 
         Gamma.R1:Gamma.R3, 
         NIRAP.Rho.R1:VELIP1.Rho.R3, 
         TALAZOP.Rho.R1:TALAZOP.Rho.R3,
         HU100.Rho.R1:HU100.Rho.R3) %>%
...
k.melt$Phenotype[k.melt$Phenotype == "VELIP1"] <- "VELIP"
...
ks.melt$Phenotype[ks.melt$Phenotype == "VELIP1"] <- "VELIP"
...
ggsave("../FIGURES/FIGURE-6/aunip_screen_k562_rho_sidebyside.svg", p3,
       height = 5, width = 7)
